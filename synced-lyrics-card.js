...
class SongInfoCard extends HTMLElement {
  static getStubConfig() { return {entity:'', card_height:'auto', show_artist_info:true, show_track_info:true, show_release_info:true, show_tags:true, show_credits:true, show_identifiers:false, show_bio:true, show_annotation:true, font_family:'system-ui', title_font_size:24, body_font_size:14, font_weight:700, alignment:'left', background_mode:'theme', background_opacity:1, artwork_blur:12, artwork_opacity:1, artwork_overlay_opacity:.45, text_color_mode:'auto', text_shadow:true, text_shadow_strength:.7}; }
